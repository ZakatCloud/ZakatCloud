...
### 🔐 EquiDex VPN
Высокопроизводительный VPN-сервис
- ⚡ Автоматическая генерация WireGuard конфигов через свой API.
- 💳 Приём платежей через **ЮMoney**.
- 🛡 Обфускация трафика для обхода DPI (поддержка **AmneziaWG**).

Ссылка : https://t.me/EquiDexBot
...
### 🐱‍👤Equidex Юзербот Go/NodeJS
Юзербот для Telegram с системой автозагрузки модулей, имеется в двух версиях на разных языках программирования
- 🌹 Оптимизирован для использования на домашних ПК
- 🔍 Включает предустановленные лёгкие модули 
- 🎁 Изоляция модулей, любые ошибки модулей не приведут к падению основного ядра
